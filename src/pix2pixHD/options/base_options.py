...
class BaseOptions():
    ...
    def parse(self, save=True):
        ...
        # Cambio el parse para que ignore aquellos parametros que no 
        # están controlados. De esta forma, se puede llamar a 
        # predict_server.py con sus parámetros normalmente.
